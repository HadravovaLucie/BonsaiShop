    ...
    return (
      <div>
        <div style={{ padding: 10, display: "flex", alignItems: "center" }}>
          ...
          />
          {usePriceFilter && (
            <Tooltip title="Změnit" disableFocusListener>
              <Button
                variant="outlined"
          ...
          >
            <MenuItem value={"lh"}>Seřadit podle ceny: Od nejnižší po nejvyšší</MenuItem>
            <MenuItem value={"hl"}>Seřadit podle ceny: Od nejvyšší po nejnižší</MenuItem>
          </Select>
        </div>
