...
import {deleteCartItem, updateCartItemQnt} from "../../Redux/Actions";
              ...
              {this.props.checkedOutItems.map((item, index) => {
                return (
                  <TableRow key={item.id}>
                    ...
                    <TableCell><Button color="secondary" /* onClick={() => {props.dispatch(deleteCartItem(item.id));}} */>Odebrat</Button></TableCell>
                  </TableRow>
                );
              })}
            </TableBody>
